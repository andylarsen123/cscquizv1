document.addEventListener("DOMContentLoaded", function () {
  ...
  const questions = [
    ...
    },
    {
      ...
      answers: [
        { text: "Shoreline setbacks", result: followUp: 6 },
    ...
    },
    {
      ...
      answers: [
        ...
        { text: "Shoreline setback: How is it used and what are possible obstacles to implementation?", result: "<strong>How it is used:</strong><br>Shoreline setbacks can be established by a local community through zoning and/or ordinances.<br><br>“The cheapest coastal protection is the one that you don’t need to build, because the building has a proper setback.” – Urban Land Institute<br><br><strong>Possible obstacles to implementation:</strong><br>-Setbacks may be viewed as restrictions on development potential<br>-Setback distances need to be adjusted in the future to reflect changes in sea levels and erosion" },
        { text: "Shoreline setback: Example", result: "</strong>City of Manistee's General Provisions: Water Protection (Sec. 505):<br>“With the exception of walkways, docks, launches, and boathouses, setback distances are increased to between 20 and 100 feet from the ordinary high water mark, depending on the district." },
        { text: "Shoreline setback: Tool checklist", result: "1. Will this regulation apply to all zoning districts along the shoreline? If so, consider a shoreline setback overlay district (see Shoreline overlay tool). Otherwise, make sure the ordinance language is clear about what districts this applies to.<br><br>

2. Is the proposed regulation supported by the Comprehensive Plan goals, objectives and/or recommended actions?<br><br>

3. Does the intent statement(s) need to be revised to reflect the reasoning for this regulation?<br><br>

4. Are all key terms included in the Definition section (e.g., Ordinary High Water Mark, water’s edge, etc)?<br><br>

5. Does the ordinance clearly identify what structures or activities are subject to the setback requirement (e.g., accessory buildings, septic systems, stairways, decks, etc.)?<br><br>

6. Is this shoreline setback clearly referenced in all sections that include setback requirements (i.e., charts, conditional use standards)?<br><br>

7. How will non-conforming structures be handled? Does this section need to be amended to clarify what future additions might be allowed for existing single-family dwellings, which typically have more flexibility for additions?<br><br>

8. Will the ordinance include a regular review of the setback requirement to respond to ongoing erosion?
" },
      ]
    },
  ];
