document.addEventListener("DOMContentLoaded", function() {
  ...
  // Ensure results is hidden on page load
  ...
  function startQuiz() {
      ...
      // Make sure the quiz controls are visible and results hidden
  ...
  function displayResults() {
      ...
      resultsDiv.classList.remove("hidden"); // Reveal the results section now
  ...
  function resetQuiz() {
      ...
      resultsDiv.classList.add("hidden"); // Hide results if resetting
  }
