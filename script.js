  ...
  const questions = [
    ...
    },
    {
      ...
      answers: [
        ...
        { text: "Coastal flooding", followUp: 3 },  // This already points to "What's the main concern?"
        { text: "Erosion", followUp: 3 },
        { text: "Natural features protection", followUp: 3 },
        { text: "Bluff stability", followUp: 3 },
        { text: "Building/Infrastructure protection", followUp: 3 },
        { text: "Urban heat", followUp: 3 }
      ]
    },
    {
