  ...
  const questions = [
    ...
    },
    {
      ...
      answers: [
        ...
        { text: "Example of a shoreline setback", result: "</strong>City of Manistee's General Provisions: Water Protection (Sec. 505):<br>“With the exception of walkways, docks, launches, and boathouses, setback distances are increased to between 20 and 100 feet from the ordinary high water mark, depending on the district." },
